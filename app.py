...
st.image("kygws.png", width=800)
image1 = Image.open('TNAULogo.png')
image2 = Image.open('AECRILogo.png')
...
if selected == "About":
    ...
    cols=st.columns(2)
    with cols[0]:
      st.image("stages_firka.png", use_column_width=True)
    with cols[1]:
      st.image("Firka_map.png", use_column_width=True)

if selected == "Status Check":
    st.title(f"{selected}")

    df = pd.read_csv("firka.csv")
    ...
    with cols[0]:
      ...
      df_status=status
      if status=="Safe":
        st.image("Safe.png", use_column_width=True)
        st.markdown(
    """
    ...
    unsafe_allow_html=True
      ...
      if status=="Semi-Critical":
        st.image("Semicritical.png", use_column_width=True)
        st.markdown(
    """
    <div style='text-align: center;'>
        <span style='color: blue; font-weight: bold;'>2011</span>
    ...
    unsafe_allow_html=True
      ...
      if status=="Critical":
        st.image("Critical.png", use_column_width=True)
        st.markdown(
    """
    <div style='text-align: center;'>
        <span style='color: blue; font-weight: bold;'>2011</span>
    ...
    unsafe_allow_html=True
      ...
      if status=="Over-Exploited":
        st.image("Overexploited.png", use_column_width=True)
        st.markdown(
    """
    <div style='text-align: center;'>
        <span style='color: blue; font-weight: bold;'>2011</span>
    ...
    unsafe_allow_html=True
      ...
      if status=="Saline":
        st.image("Saline.png", use_column_width=True)
        st.markdown(
    """
    <div style='text-align: center;'>
        <span style='color: blue; font-weight: bold;'>2011</span>
    ...
    wb = openpyxl.load_workbook("GWL_masterdata.xlsx")
